...
import torch
from causality_vmas.utils import discretize_df, get_df_boundaries
from path_repo import GLOBAL_PATH_REPO
from causality_vmas.causality_algos import CausalDiscovery, CausalInferenceForRL
...
if __name__ == '__main__':
    df = pd.read_pickle(f'{GLOBAL_PATH_REPO}/causality_vmas/causal_knowledge/offline_ok/df_random_{obs}_1000000.pkl')
    df = df.head(n_rows)
    ...
    cd = CausalDiscovery(new_df, f'causality_vmas/causal_knowledge/offline/navigation', f'agent{agent_n}_{obs}')
    ...
    ci = CausalInferenceForRL(df_for_causality, causal_graph,
                              dir_name=f'causality_vmas/causal_knowledge/offline/navigation',
    ...
    causal_table.to_pickle(f'{GLOBAL_PATH_REPO}/causality_vmas/causal_knowledge/offline/causality_vmas/causal_table.pkl')
    causal_table.to_pickle(f'{GLOBAL_PATH_REPO}/causality_vmas/causal_knowledge/offline/causality_vmas/causal_table.xlsx')"""
